...
public class IAPKey
{
    public const string PACK0 = "starter";
    public const string PACK1 = "sale_1";
    public const string PACK2 = "coins_50";
    public const string PACK3 = "coins_100";
    public const string PACK4 = "coins_200";
    public const string PACK5 = "life_5";
}
