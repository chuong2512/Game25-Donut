...
namespace DonutMatach
{
    ...
    public static class GameObjectExtensions
    {
        ...
        public static void GetChilds(this GameObject g, ref List<GameObject> gList)
        {
        ...
        /// <param name="g"></param>
        /// <param name="gList"></param>
        public static void GetChilds(this GameObject g, bool recursively, ref List<GameObject> gList)
        {
            if(recursively) GetChilds(g, ref gList);
            else
            {
                int childs = g.transform.childCount;
                if (childs > 0)//The condition that limites the method for calling itself
        ...
        public static void SetInActive(this GameObject g, bool val)
        {
            g.SetActive(!val);
        }
    }
