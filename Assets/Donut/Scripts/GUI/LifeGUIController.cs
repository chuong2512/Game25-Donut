...
namespace DonutMatach
{
    ...
    {
        [SerializeField] private GameObject lifesGroup;
        ...
        private void RefreshTimerText()
        {
            ...
            if (timerText)
            {
                ...
                {
                    if (restHours != infiniteLifeTimer.RestHours || restMinutes != infiniteLifeTimer.RestMinutes ||
                        restSeconds != infiniteLifeTimer.RestSeconds)
                    {
                        ...
                        restSeconds = infiniteLifeTimer.RestSeconds;
                        timerText.text =
                            restHours.ToString("00") + ":" +
                            restMinutes.ToString("00"); // + ":" + restSeconds.ToString("00");
                    }
