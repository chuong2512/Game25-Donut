...
namespace DonutMatach
{
    ...
    {
        [SerializeField] private Text dealTimeText;
        [SerializeField] private Button dealTimeButton;
        [SerializeField] private Format timeFormat = Format.F3;

        #region temp vars

        private DealSaleController DSC
        {
            get { return DealSaleController.Instance; }
        }
