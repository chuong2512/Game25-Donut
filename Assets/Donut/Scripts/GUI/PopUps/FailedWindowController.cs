...
namespace DonutMatach
{
    public class FailedWindowController : PopUpsController
    {
        ...
        [SerializeField] private GameObject scoreUnComplete;

        [Space(8)] [Header("Targets")] [SerializeField]
        private Text scoreText;

        [SerializeField] private GUIObjectTargetHelper targetPrefab;
        [SerializeField] private RectTransform targetsContainer;

        [Space(8)] [Header("Boosters")] [SerializeField]
        private RectTransform BoostersParent;

        [SerializeField] private int boostersCount = 3;
        ...
        private void Start()
        {
            ...
            if (useAds && failsCounter % 2 == 0)
            {
                if (AdsControl.Instance)
                    AdsControl.Instance.ShowInterstitial(() => { MSound.ForceStopMusic(); },
